    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 offset-lg-2">
          <div class="section-heading  wow fadeInDown animated" data-wow-duration="1s" data-wow-delay="0.5s" style={ {visibility: "visible;-webkit-animation-duration: 1s;", mozAnimationDuration: "1s;", animationDuration: "1s;", webkitAnimationDelay: "0.5s;", mozAnimationDelay: "0.5s;", animationDelay: "0.5s;"} }>
